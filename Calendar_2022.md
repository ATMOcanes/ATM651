...
Sep 19-21|Survey situation: rising out of the basement (with [this vocabulary]() in hand). Phenom: Fiona IDV data bath. "Where did Fiona's vorticity come from?" Stare at d/dt(vort) = 0 + complications to answer. HW2 back, a few clarifications. [Mingpo's nice kinematics nb](https://colab.research.google.com/drive/1QAnKTiUojvxLp029IYFsSq3hhvEouE51#scrollTo=wT-RwDUfG5jK). Finish First Law trick, make it look like d/dt(warmth) = 0 + diabatic processes. **Assign -->** | **Come prepared to discuss vorticity [movies](http://web.mit.edu/hml/ncfmf.html), Parts 1&2**. Each student please jot down at least one time-stamped question or classroom discussion point. Project tool/idea: If you like, please install and test-drive [this ppt's topic: The IDV with MERRA-2 atmospheric reanalysis data](https://github.com/ATMOcanes/ATM651/tree/master/Projects-IDV-MERRA2), and check out the MERRA2 [data collections](https://gmao.gsfc.nasa.gov/pubs/docs/Bosilovich785.pdf).  
Sep 26-28	||
Oct 3-5 ||
